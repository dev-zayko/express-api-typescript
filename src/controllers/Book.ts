...
const readBook = async(req: Request, res: Response, _next: NextFunction) => {
...
const updateBook = async(req: Request, res: Response, _next: NextFunction) => {
    const bookId = req.params.bookId;
...
const deleteBook = async(req: Request, res: Response, _next: NextFunction) => {
    const bookId = req.params.bookId;
